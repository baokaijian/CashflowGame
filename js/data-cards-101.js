...
window.DECK_SMALL = [
  ...
  { id:'sm5',  kind:'realestate', nm:'小区车位', dp:6500,  cost:139800,  cf:100, rent:400,
    note:'总价 ¥139,800，首付 ¥6,500，出租月收入 ¥400（净现金流 +¥100）。' },
  { id:'sm6',  kind:'realestate', nm:'单身公寓', dp:10800,  cost:161300,  cf:200, rent:600,
    note:'总价 ¥161,300，首付 ¥10,800，出租月收入 ¥600（净现金流 +¥200）。' },
  { id:'sm7',  kind:'realestate', nm:'地铁口小商铺', dp:17200, cost:236500, cf:400, rent:1000,
    note:'总价 ¥236,500，首付 ¥17,200，出租月收入 ¥1,000（净现金流 +¥400）。' },
  { id:'sm8',  kind:'realestate', nm:'老破小', dp:4300, cost:107500, cf:-100, rent:300,
    note:'总价 ¥107,500，首付 ¥4,300，租金偏低净现金流 −¥100。等待拆迁或行情回暖后出手。' },
  { id:'sm9',  kind:'savings', nm:'高收益债基金', cost:10800, interest:50,
    note:'投入 ¥10,800，月度派息 +¥50（年化约 12%）。收益高伴随信用风险，本金可能波动。' },
  { id:'sm10', kind:'business', nm:'社区团购团长', cost:10800, cf:150,
    note:'投入 ¥10,800 做社区团购副业，月净收入 +¥150。' },
...
window.DECK_BIG = [
  { id:'bg1', kind:'realestate', nm:'三居室住宅',  dp:86000, cost:645000, cf:1600, rent:3600,
    note:'总价 ¥645,000，首付 ¥86,000，出租月收入 ¥3,600（净现金流 +¥1,600）。' },
  { id:'bg2', kind:'realestate', nm:'学区房',     dp:129000, cost:967500, cf:2400, rent:5400,
    note:'总价 ¥967,500，首付 ¥129,000，出租月收入 ¥5,400（净现金流 +¥2,400）。' },
  { id:'bg3', kind:'realestate', nm:'整层写字楼',  dp:172000, cost:1290000, cf:3200, rent:7200,
    note:'总价 ¥1,290,000，首付 ¥172,000，出租月收入 ¥7,200（净现金流 +¥3,200）。' },
  { id:'bg4', kind:'realestate', nm:'沿街商铺',  dp:107500, cost:860000, cf:2500, rent:4000,
    note:'总价 ¥860,000，首付 ¥107,500，出租月收入 ¥4,000（净现金流 +¥2,500）。' },
  { id:'bg5', kind:'business', nm:'连锁奶茶加盟',  cost:161300, cf:1200,
    note:'加盟出资 ¥161,300，月净收入 +¥1,200。' },
  { id:'bg6', kind:'business', nm:'社区生鲜超市',  cost:64500, cf:1600,
    note:'开店投入 ¥64,500，月净收入 +¥1,600。' },
  { id:'bg7', kind:'business', nm:'快递驿站',      cost:53800, cf:1000,
    note:'接手驿站 ¥53,800，月净收入 +¥1,000。' },
  { id:'bg8', kind:'business', nm:'新能源充电桩',  cost:96800, cf:2000,
    note:'自建充电桩 ¥96,800，月净收入 +¥2,000。' },
  { id:'bg9', kind:'business', nm:'小酒馆',       cost:43000, cf:1000, risky:true,
    note:'投入 ¥43,000，月净收入 +¥1,000；受消费行情影响，存在客流枯竭风险。' },
  ...
  { id:'bg12',kind:'savings', nm:'债权转让项目', cost:43000, interest:700,
    note:'受让债权 ¥43,000，月派息 +¥700（年化约 42%，属于高风险项目，请谨慎）。' }
];
