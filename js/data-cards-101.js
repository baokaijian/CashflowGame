...
window.DECK_SMALL = [
  ...
  { id:'sm5', opProfile:'parking',  kind:'realestate', tier:'park', nm:'小区车位', dp:55920,  cost:139800,  cf:297, rent:641,
    note:'总价 ¥139,800，首付 ¥55,920（40%），出租月收入 ¥641（净现金流 +¥297 · 净回报 6.4%/年）。' },
  { id:'sm6', opProfile:'housing',  kind:'realestate', tier:'res', nm:'单身公寓', dp:48390,  cost:161300,  cf:209, rent:672,
    note:'总价 ¥161,300，首付 ¥48,390（30%），出租月收入 ¥672（净现金流 +¥209 · 净回报 5.2%/年）。' },
  { id:'sm7', opProfile:'commercial',  kind:'realestate', tier:'com', nm:'地铁口小商铺', dp:106425, cost:236500, cf:650, rent:1183,
    note:'总价 ¥236,500，首付 ¥106,425（45%），出租月收入 ¥1,183（净现金流 +¥650 · 净回报 7.3%/年）。' },
  { id:'sm8', opProfile:'agingHousing',  kind:'realestate', tier:'res', nm:'老破小', dp:32250, cost:107500, cf:-130, rent:179,
  ...
  { id:'sm10', opProfile:'self', kind:'business', tier:'self', nm:'社区团购团长', cost:10800, cf:99,
...
window.DECK_BIG = [
  { id:'bg1', opProfile:'housing', kind:'realestate', tier:'res', nm:'三居室住宅',  dp:193500, cost:645000, cf:837, rent:2688,
    note:'总价 ¥645,000，首付 ¥193,500（30%），出租月收入 ¥2,688（净现金流 +¥837 · 净回报 5.2%/年）。' },
  { id:'bg2', opProfile:'housing', kind:'realestate', tier:'res', nm:'学区房',     dp:290250, cost:967500, cf:1254, rent:4031,
    note:'总价 ¥967,500，首付 ¥290,250（30%），出租月收入 ¥4,031（净现金流 +¥1,254 · 净回报 5.2%/年）。' },
  { id:'bg3', opProfile:'commercial', kind:'realestate', tier:'com', nm:'整层写字楼',  dp:580500, cost:1290000, cf:3541, rent:6450,
    note:'总价 ¥1,290,000，首付 ¥580,500（45%），出租月收入 ¥6,450（净现金流 +¥3,541 · 净回报 7.3%/年）。' },
  { id:'bg4', opProfile:'commercial', kind:'realestate', tier:'com', nm:'沿街商铺',  dp:387000, cost:860000, cf:2361, rent:4300,
    note:'总价 ¥860,000，首付 ¥387,000（45%），出租月收入 ¥4,300（净现金流 +¥2,361 · 净回报 7.3%/年）。' },
  { id:'bg5', opProfile:'brand', kind:'business', tier:'brand', nm:'连锁奶茶加盟',  cost:161300, cf:1210,
    note:'加盟出资 ¥161,300，月净收入 +¥1,210（净回报 9.0%/年）。' },
  { id:'bg6', opProfile:'self', kind:'business', tier:'self', nm:'社区生鲜超市',  cost:64500, cf:591,
    note:'开店投入 ¥64,500，月净收入 +¥591（净回报 11.0%/年）。' },
  { id:'bg7', opProfile:'self', kind:'business', tier:'self', nm:'快递驿站',      cost:53800, cf:493,
    note:'接手驿站 ¥53,800，月净收入 +¥493（净回报 11.0%/年）。' },
  { id:'bg8', opProfile:'equipment', kind:'business', tier:'self', nm:'新能源充电桩',  cost:96800, cf:887,
    note:'自建充电桩 ¥96,800，月净收入 +¥887（净回报 11.0%/年）。' },
  { id:'bg9', opProfile:'self', kind:'business', tier:'self', nm:'小酒馆',       cost:43000, cf:394, risky:true,
