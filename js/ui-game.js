...
function renderRules(){
  ...
  <div class="rules">
    ...
    <ul>
      ...
      <li>经过或停在<b>发薪日</b>：<b>一次结算</b>结清「自上次结算以来经过的年份」——
        入账 = <b>年度结余 × 年数</b>（年收入 − 年支出），并偿还同等年数的贷款本金（每年 12 期）。
        <b>每个发薪日恰好结算一次</b>：同一回合经过多个发薪日时，第 2 个起本年已结、不再重复发钱；
        两次发薪日之间隔了几年，那一次就一次结清几年（日志会给出「年结余 × 年数」的算式）。</li>
