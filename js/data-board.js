...
/* ---------- 内圈：老鼠赛跑（掷 1 粒骰子） ---------- */
window.RAT_RACE = [
  /* 内圈 3 个等距发薪日（2 / 10 / 18）。每经过一个就结算 1 年、长 1 岁。
     单骰最多跨 1 个，银翅膀双骰最多跨 2 个；没有积欠或略过。 */
  { t:'start',        nm:'起点',     ico:'🏁', sub:'休假 · 恢复精力' },
  { t:'opportunity',  nm:'投资机会',  ico:'💡', sub:'理财 / 置业' },
  { t:'paycheck',     nm:'发薪日',    ico:'💰', sub:'结算 1 年' },
...
/* ---------- 外圈：财务自由圈（掷 2 粒骰子） ---------- */
window.FAST_TRACK = [
  /* 外圈 4 个分红日，同样每格结算一年并长一岁。
     多个分红日逐笔结算，达到终龄后停在最后一个结算日。 */
...
window.PORTFOLIOS = [
  ...
  { nm:'老破小出租房',  ico:'🏘️', financingVersion:1, realEstate:[{ nm:'老破小出租房', tier:'res', dp:50000, cost:170000, projectDebt:120000, financingRate:0.0041, cf:216, rent:708 }],
                                    note:'首付 ¥50,000（29%）· 出租月收入 ¥708 · 项目融资 ¥120,000（月息 ¥492，净现金流 +¥216；出售时还本）' },
...
/* ---------- 游戏模式 ---------- */
window.GAME_MODES = {
  age    :{ nm:'年龄模式', desc:'20 岁起步，每经过一个发薪日或分红日，结算一年并长一岁；65 岁结束，共 45 次年度结算，轮数不限。' },
